...
The API exposes the single POST points of `report` to download software
from the given URL and return a textual analysis of its structure and
functionality.
...
- os:
  ...
  Name of operating system, passed to remotes package to install system
  dependencies.

- os_release:

  Name of operating system release, passed to remotes package to install
  system dependencies.
