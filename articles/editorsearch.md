...
[`gm_auth()`](https://gmailr.r-lib.org/reference/gm_auth.html) call — a
mismatch forces a fresh interactive re-authorization, which does not
...
[`gm_from()`](https://gmailr.r-lib.org/reference/accessors.html) on each
outgoing message.
...
- `gmail_send(to, subject, html_body)` builds and sends one message via
  [`gm_mime()`](https://gmailr.r-lib.org/reference/gm_mime.html)/[`gm_from()`](https://gmailr.r-lib.org/reference/accessors.html)/[`gm_to()`](https://gmailr.r-lib.org/reference/accessors.html)/[`gm_subject()`](https://gmailr.r-lib.org/reference/accessors.html)/[`gm_html_body()`](https://gmailr.r-lib.org/reference/gm_mime.html)/
  [`gm_send_message()`](https://gmailr.r-lib.org/reference/gm_send_message.html).
...
- Call
  ...
  against a real/test issue; confirm delivery from
